...
The scope of our Orbital project can be broken down into 2 parts - Business features and Consumer features 
...
<span style="text-decoration:underline;">Splash Screen </span>

Upon opening the app, all users are directed to the splash screen, they will be prompted to sign up or register. When registering, users will be able to select the type of account (User or Business). Upon logging in, user is authenticated and redirected to the homepage according to their account type.
...
<span style="text-decoration:underline;">Homepage (Classes **Near You** and **My Favourite** Classes)</span>

Upon logging in, users are brought to the homescreen where they will be able to view classes in their area according to the region they selected during registration and the classes they have bookmarked into Favourites. Users are able to scroll to browse through the classes and they will be redirected to the Class Details page when they select a class.
...
<span style="text-decoration:underline;">Filter Classes</span>

Users can browse and find classes using the filter function. They can select their preferred region, category and price range. Users can select 1 or multiple categories. 
...
<span style="text-decoration:underline;">Class Details</span>

When users click on a class, they are redirected to the class details page where they can read more information about the class and make a booking for the class. Users can also share the class using the share icon or add the class to Favourites using the heart icon. Favourited classes will be displayed on the homepage.
...
<span style="text-decoration:underline;">My Bookings page (View and Cancel bookings)</span>

Booked classes will be displayed here. When users click on a booking, they will be redirected to the page on the right where they can view more details or cancel the booking.
...
<span style="text-decoration:underline;">Profile page</span>

On the profile page, the ‘Settings’ option will redirect them to the Edit Profile page where users can make changes to their username, region and profile picture. ‘Past Classes’ will redirect them to the page below, displaying the past classes they booked.
...
<span style="text-decoration:underline;">Rate Classes</span>

Upon clicking a past class, users can leave a rating for the business that conducted the class and the overall ratings will be reflected in the class details page.
...
<span style="text-decoration:underline;">Homepage (My Classes) </span>

Upon logging in to a business account, the user will be redirected to the homepage where businesses can view their listed classes in order of date added. When they click on a class they will be redirected to the class details page where they can view the attendees who booked the class.
...
<span style="text-decoration:underline;">Add Class</span>

Businesses can enter their details and upload classes through this page. Classes will be displayed on the ‘My Classes’ tab.
...
In the profile page, businesses can log out, edit profile details and view history of listed classes.
